...
$envVars = "AI_PROVIDER=auto,AI_RERANK_PROVIDER=none,AI_RERANK_TIMEOUT_SECONDS=0.7,GEMINI_MODEL=gemini-2.5-flash-lite,IMAGE_IMPORT_MODEL=gemini-2.5-flash-lite,IMAGE_IMPORT_TIMEOUT_SECONDS=90,STOCKFISH_PATH=/usr/games/stockfish,STOCKFISH_RECOMMEND_MS=700,STOCKFISH_EXPECTED_MS=650,STOCKFISH_BOT_MS=900,STOCKFISH_CRITICAL_MS=1200,FRONTEND_ORIGIN_REGEX=$corsRegex,RATE_LIMIT_WINDOW_SECONDS=60,RATE_LIMIT_PER_WINDOW=45"
